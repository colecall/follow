    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        <h3><i class="menu-icon fa-brands fa-instagram fa-fade"
                                style="color: #ff0000;"></i>{{ _('Follow My Instagram Account') }}</h3>
                        <hr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="switch switch-success">
                                            ...
                                            <span class="switch-label">{{ $realAccount->status }}</span>
                                        </label>
                                    </td>
                                </tr>
                            @endforeach
                            ...
                            <form action="{{ route('real.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <select class="form-select" aria-label="Default select example" name="category">
                                        ...
                                        <option value="Follow Instagram Account">Follow Instagram Account</option>
                                    </select>
                                </div>
