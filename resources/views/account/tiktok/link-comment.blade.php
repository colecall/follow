    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h3><i class="menu-icon fa-brands fa-tiktok fa-fade"></i>{{ _('Comment My Tiktok Video') }}</h3>
                        <hr>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="realAccountModalLabel">Link Video</h5>
                            ...
                            <form action="{{ route('real.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <select class="form-select" aria-label="Default select example" name="category">
                                        ...
                                        <option value="Comment Tiktok Video">Comment Tiktok Video</option>
                                    </select>
                                </div>
                                <div class="row">
                                    <div class="col-12"
